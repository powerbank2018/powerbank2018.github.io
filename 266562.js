...
window.btw_init[266562] = function () {
	(function(window, document) {
	    ...
	    var adds = {};
	    try {
		    if(window.__adds_params__ !== undefined && window.__adds_params__[266562] !== undefined) {
		    	adds = window.__adds_params__;
		    } else {
		    	if(
		    		window.subid_266562 !== undefined ||
		    		window.btw_click3rd_266562 !== undefined ||
		    		(window.pubdata !== undefined && window.pubdata[266562] !== undefined) ||
		    		(window.itu !== undefined && window.itu[266562] !== undefined)
		    	) {
		    		adds[266562] = {}
		    	}

		    	if(window.subid_266562 !== undefined) {
		    		adds[266562].subid = window.subid_266562		    	}
		    	if(window.btw_click3rd_266562 !== undefined) {
		    		adds[266562].btw_click3rd = window.btw_click3rd_266562		    	}
		    	if(window.pubdata !== undefined && window.pubdata[266562] !== undefined) {
		    		adds[266562].pubdata = window.pubdata[266562]
		    	}
		    	if(window.itu !== undefined && window.itu[266562] !== undefined) {
		    		adds[266562].itu = window.itu[266562]
		    	}
		    }
		} catch(e) {
	    	errors.push({id: 266562, where: 'http://cache.betweendigital.com/sections/2/section.adds', e: e});
	    ...
	    var section = {
	        ...
	        h: '90',
							        container: document.getElementById('b_script_266562') || {},
	        ...
	        include: function(url, onload) {
	        	try {
		            ...
		            var con = document.getElementById('b_script_266562');
		            if(con !== null && con !== undefined) {
		                con.appendChild(script);
		            }
	            } catch(e) {
			    	errors.push({id: 266562, where: 'section.include_func', e: e});
			        send_log(errors, document, window)
			        throw e;
			    }
	            return script;
	    ...
	    if (!pixel) {
	    	try {/*
	            if (window.subid_266562 !== undefined) {
	                pixelParams.push(['subid', window.subid_266562]);
	            }
	            if (window.btw_click3rd_266562 !== undefined) {
	                pixelParams.push(['click3rd', window.btw_click3rd_266562]);
	            }*/
	            var img = new Image();
