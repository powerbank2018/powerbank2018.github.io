...
window.btw_init[1786539] = function () {
	(function(window, document) {
	    ...
	    var adds = {};
	    try {
		    if(window.__adds_params__ !== undefined && window.__adds_params__[1786539] !== undefined) {
		    	adds = window.__adds_params__;
		    } else {
		    	if(
		    		window.subid_1786539 !== undefined ||
		    		window.btw_click3rd_1786539 !== undefined ||
		    		(window.pubdata !== undefined && window.pubdata[1786539] !== undefined) ||
		    		(window.itu !== undefined && window.itu[1786539] !== undefined)
		    	) {
		    		adds[1786539] = {}
		    	}

		    	if(window.subid_1786539 !== undefined) {
		    		adds[1786539].subid = window.subid_1786539		    	}
		    	if(window.btw_click3rd_1786539 !== undefined) {
		    		adds[1786539].btw_click3rd = window.btw_click3rd_1786539		    	}
		    	if(window.pubdata !== undefined && window.pubdata[1786539] !== undefined) {
		    		adds[1786539].pubdata = window.pubdata[1786539]
		    	}
		    	if(window.itu !== undefined && window.itu[1786539] !== undefined) {
		    		adds[1786539].itu = window.itu[1786539]
		    	}
		    }
		} catch(e) {
	    	errors.push({id: 1786539, where: 'http://cache.betweendigital.com/sections/2/section.adds', e: e});
	    ...
	    var section = {
			...
			rotate: 0,
	        video_url: '//ads.betweendigital.com/adv?s=1786539&maxd=30&mind=5&w=640&h=360&startdelay=0',	        w: '640',
	        h: '360',
			other_ad: "adluxe",			video_fallback: "%3Ca%20href%3D%22https%3A%2F%2Fdomains.jino.ru%2F%3Futm_source%3Djinoparking%26utm_medium%3Dbetween%26utm_campaign%3Ddomains%26utm_content%3Dfairprice%22%20target%3D%22_blank%22%3E%3Cimg%20src%3D%22%2F%2Fparking.jino.ru%2Fstatic%2Fbnr%2F300x250-domains39.jpg%22%20width%3D%22300%22%20height%3D%22250%22%20alt%3D%22%22%20border%3D%220%22%20%2F%3E%3C%2Fa%3E",	        container: document.getElementById('b_script_1786539') || {},
	        ...
	        include: function(url, onload) {
	        	try {
		            ...
		            var con = document.getElementById('b_script_1786539');
		            if(con !== null && con !== undefined) {
		                con.appendChild(script);
		            }
	            } catch(e) {
			    	errors.push({id: 1786539, where: 'section.include_func', e: e});
			        send_log(errors, document, window)
			        throw e;
			    }
	            return script;
	    ...
	    if (!pixel) {
	    	try {/*
	            if (window.subid_1786539 !== undefined) {
	                pixelParams.push(['subid', window.subid_1786539]);
	            }
	            if (window.btw_click3rd_1786539 !== undefined) {
	                pixelParams.push(['click3rd', window.btw_click3rd_1786539]);
	            }*/
	            var img = new Image();
